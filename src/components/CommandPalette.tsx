        ...
        <Command className="w-full">
          ...
          <Command.List className="max-h-[300px] overflow-y-auto p-2 scrollbar-thin scrollbar-thumb-slate-700">
            ...
            <Command.Group heading="Social" className="text-xs text-slate-500 font-medium px-2 py-1 [&_[cmdk-group-heading]]:mb-2 uppercase tracking-wider">
              ...
              <Command.Item onSelect={() => openLink('https://linkedin.com/')} className="flex items-center gap-3 px-3 py-2 text-sm text-textPrimary rounded-md cursor-pointer hover:bg-primary/20 hover:text-primary transition-colors mb-1 aria-selected:bg-primary/20 aria-selected:text-primary">
                <FaLinkedin /> LinkedIn
              </Command.Item>
            </Command.Group>
          </Command.List>
